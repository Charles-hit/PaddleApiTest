...
class TestRsqrtDevelopCase1_FP32(unittest.TestCase):
    def init_dtype(self):
        self.dtype = "float32"

    def init_params(self):
        self.x_shape = [10, 181, 1]
        self.dout_shape = [10, 181, 1]
        self.init_dtype()
    ...
    def init_np_inputs_and_dout(self):
        ...
        # self.np_x = np.random.random(size=self.x_shape).astype("float32")
        self.np_dout = (
...
class TestRsqrtDevelopCase1_FP16(TestRsqrtDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float16"

class TestRsqrtDevelopCase1_BF16(TestRsqrtDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"
