...
class TestMemoryEfficientAttentionDevelopCase1_FP32(unittest.TestCase):
    def init_dtype(self):
        self.dtype = "float32"
    ...
    def cal_eager_res(self, q, k, v, attn_mask, dropout_p, is_causal, training, dout):
        ...
        out = memory_efficient_attention(q_t, k_t, v_t, p=dropout_p, training=training)
        # breakpoint()
...
class TestMemoryEfficientAttentionDevelopCase1_FP16(TestMemoryEfficientAttentionDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float16"

class TestMemoryEfficientAttentionDevelopCase1_BF16(TestMemoryEfficientAttentionDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"

class TestMemoryEfficientAttentionDevelopCase2_FP32(TestMemoryEfficientAttentionDevelopCase1_FP32):
    def init_params(self):
...
class TestMemoryEfficientAttentionDevelopCase2_FP16(TestMemoryEfficientAttentionDevelopCase2_FP32):
    def init_dtype(self):
        self.dtype = "float16"

class TestMemoryEfficientAttentionDevelopCase2_BF16(TestMemoryEfficientAttentionDevelopCase2_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"
