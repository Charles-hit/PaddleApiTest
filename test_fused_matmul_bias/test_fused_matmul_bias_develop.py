...
def generate_np_inputs_and_dout():
    ...
    x_case8 = np.random.random(size=[1, 8192, 12288]).astype("float32")
    w_case8 = np.random.random(size=[12288, 32032]).astype("float32")
    b_case8 = np.random.random(size=[32032]).astype("float32")
    dout_case8 = np.random.random(size=[1, 8192, 32032]).astype("float32")

    x_case9 = np.random.random(size=[8, 128, 12288]).astype("float32")
    w_case9 = np.random.random(size=[12288, 9216]).astype("float32")
    b_case9 = np.random.random(size=[9216]).astype("float32")
    dout_case9 = np.random.random(size=[8, 128, 9216]).astype("float32")

    x_case10 = np.random.random(size=[8, 128, 4608]).astype("float32")
    w_case10 = np.random.random(size=[4608, 12288]).astype("float32")
    b_case10 = np.random.random(size=[12288]).astype("float32")
    dout_case10 = np.random.random(size=[8, 128, 12288]).astype("float32")

    x_case11 = np.random.random(size=[8192, 12288]).astype("float32")
    w_case11 = np.random.random(size=[12288, 1792]).astype("float32")
    b_case11 = np.random.random(size=[1792]).astype("float32")
    dout_case11 = np.random.random(size=[8192, 1792]).astype("float32")

    x_case12 = np.random.random(size=[8192, 12288]).astype("float32")
    w_case12 = np.random.random(size=[12288, 9216]).astype("float32")
    b_case12 = np.random.random(size=[9216]).astype("float32")
    dout_case12 = np.random.random(size=[8192, 9216]).astype("float32")

    x_case13 = np.random.random(size=[8192, 1536]).astype("float32")
    w_case13 = np.random.random(size=[1536, 1228]).astype("float32")
    b_case13 = np.random.random(size=[1228]).astype("float32")
    dout_case13 = np.random.random(size=[8192, 1228]).astype("float32")

    x_case14 = np.random.random(size=[8192, 4608]).astype("float32")
    w_case14 = np.random.random(size=[4608, 12288]).astype("float32")
    b_case14 = np.random.random(size=[12288]).astype("float32")
    dout_case14 = np.random.random(size=[8192, 12288]).astype("float32")
    ...
    # np.savez("./inputs_case8.npz", x = x_case8, w = w_case8, b = b_case8, dout = dout_case8)
    # np.savez("./inputs_case9.npz", x = x_case9, w = w_case9, b = b_case9, dout = dout_case9)
    # np.savez("./inputs_case10.npz", x = x_case10, w = w_case10, b = b_case10, dout = dout_case10)
    # np.savez("./inputs_case11.npz", x = x_case11, w = w_case11, b = b_case11, dout = dout_case11)
    # np.savez("./inputs_case12.npz", x = x_case12, w = w_case12, b = b_case12, dout = dout_case12)
    # np.savez("./inputs_case13.npz", x = x_case13, w = w_case13, b = b_case13, dout = dout_case13)
    # np.savez("./inputs_case14.npz", x = x_case14, w = w_case14, b = b_case14, dout = dout_case14)
...
class TestFCDevelopCase1_FP32(unittest.TestCase):
    ...
    def cal_eager_res(self, x, w, b, dout):
        ...
        out = paddle.incubate.nn.functional.fused_matmul_bias(x_t, w_t, b_t)
...
class TestFCDevelopCase8_FP32(TestFCDevelopCase1_FP32):
    def init_params(self):
...
class TestFCDevelopCase8_FP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case8.npz"
        self.num_flatten_dims = -1
        self.dtype = "float16"
...
class TestFCDevelopCase8_BFP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case8.npz"
        self.num_flatten_dims = -1
        self.dtype = "bfloat16"
...
class TestFCDevelopCase9_FP32(TestFCDevelopCase1_FP32):
    def init_params(self):
...
class TestFCDevelopCase9_FP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case9.npz"
        self.num_flatten_dims = -1
        self.dtype = "float16"
...
class TestFCDevelopCase9_BFP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case9.npz"
        self.num_flatten_dims = -1
        self.dtype = "bfloat16"
...
class TestFCDevelopCase10_FP32(TestFCDevelopCase1_FP32):
    def init_params(self):
...
class TestFCDevelopCase10_FP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case10.npz"
        self.num_flatten_dims = -1
        self.dtype = "float16"
...
class TestFCDevelopCase10_BFP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case10.npz"
        self.num_flatten_dims = -1
        self.dtype = "bfloat16"
...
class TestFCDevelopCase11_FP32(TestFCDevelopCase1_FP32):
    def init_params(self):
...
class TestFCDevelopCase11_FP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case11.npz"
        self.num_flatten_dims = -1
        self.dtype = "float16"
...
class TestFCDevelopCase11_BFP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case11.npz"
        self.num_flatten_dims = -1
        self.dtype = "bfloat16"
...
class TestFCDevelopCase12_FP32(TestFCDevelopCase1_FP32):
    def init_params(self):
...
class TestFCDevelopCase12_FP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case12.npz"
        self.num_flatten_dims = -1
        self.dtype = "float16"
...
class TestFCDevelopCase12_BFP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case12.npz"
        self.num_flatten_dims = -1
        self.dtype = "bfloat16"
...
class TestFCDevelopCase13_FP32(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case13.npz"
        self.num_flatten_dims = -1
        self.dtype = "float32"
        self.save_static_res_path = "./static_develop_res_case13_fp32.npz"
        self.save_eager_res_path = "./eager_develop_res_case13_fp32.npz"

class TestFCDevelopCase13_FP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case13.npz"
        self.num_flatten_dims = -1
        self.dtype = "float16"
        self.save_static_res_path = "./static_develop_res_case13_fp16.npz"
        self.save_eager_res_path = "./eager_develop_res_case13_fp16.npz"

class TestFCDevelopCase13_BFP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case13.npz"
        self.num_flatten_dims = -1
        self.dtype = "bfloat16"
        self.save_static_res_path = "./static_develop_res_case13_bfp16.npz"
        self.save_eager_res_path = "./eager_develop_res_case13_bfp16.npz" 


class TestFCDevelopCase14_FP32(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case14.npz"
        self.num_flatten_dims = -1
        self.dtype = "float32"
        self.save_static_res_path = "./static_develop_res_case14_fp32.npz"
        self.save_eager_res_path = "./eager_develop_res_case14_fp32.npz"

class TestFCDevelopCase14_FP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case14.npz"
        self.num_flatten_dims = -1
        self.dtype = "float16"
        self.save_static_res_path = "./static_develop_res_case14_fp16.npz"
        self.save_eager_res_path = "./eager_develop_res_case14_fp16.npz"

class TestFCDevelopCase14_BFP16(TestFCDevelopCase1_FP32):
    def init_params(self):
        self.np_input_dir = "./inputs_case14.npz"
        self.num_flatten_dims = -1
        self.dtype = "bfloat16"
        self.save_static_res_path = "./static_develop_res_case14_bfp16.npz"
        self.save_eager_res_path = "./eager_develop_res_case14_bfp16.npz" 
