...
class TestExpandDevelopCase1_FP32(unittest.TestCase):
    ...
    def setUp(self):
        ...
        out_torch, out_grads_torch = self.cal_torch_res(
            x_torch, self.param_shape, dout_torch
        )
        del x_torch
        del dout_torch
    ...
    def test_eager_accuracy(self):
        ...
        out_eager, out_grads_eager = self.cal_eager_res(
            x_eager, self.param_shape, dout_eager
        )
        del x_eager
        del dout_eager
...
class TestExpandDevelopCase1_FP16(TestExpandDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float16"

class TestExpandDevelopCase1_BF16(TestExpandDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"

class TestExpandDevelopCase2_FP32(TestExpandDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float32"
    def init_params(self):
        self.x_shape = [10, 1, 16, 96]
        self.param_shape = (-1, 1, -1, -1)
        self.dout_shape = [10, 1, 16, 96]
        self.init_dtype()

class TestExpandDevelopCase2_FP16(TestExpandDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float16"
    def init_params(self):
        self.x_shape = [10, 1, 16, 96]
...
class TestExpandDevelopCase2_BF16(TestExpandDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"
    def init_params(self):
        self.x_shape = [10, 1, 16, 96]
