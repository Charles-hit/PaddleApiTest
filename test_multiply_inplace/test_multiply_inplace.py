...
class TestMultiplyInplaceInplaceDevelopCase1_FP32(unittest.TestCase):
    def setUp(self):
        self.init_params()
        self.init_threshold()
    ...
    def cal_torch_res(self, x, y, dout):
        ...
        x_t = x.clone()
        y_t = y.clone()
        out = torch.Tensor.multiply_(x_t, y_t)
    ...
    def cal_eager_res(self, x, y, dout):
        ...
        x_t = paddle.assign(x)
        y_t = paddle.assign(y)
        out = paddle.tensor.multiply_(x_t, y_t)
...
class TestMultiplyInplaceInplaceDevelopCase1_FP16(
    TestMultiplyInplaceInplaceDevelopCase1_FP32
):
    def init_params(self):
        self.dtype = "float16"


class TestMultiplyInplaceInplaceDevelopCase1_BFP16(
    TestMultiplyInplaceInplaceDevelopCase1_FP32
):
    def init_params(self):
        self.dtype = "bfloat16"
...
class TestMultiplyInplaceInplaceDevelopCase2_FP32(
    TestMultiplyInplaceInplaceDevelopCase1_FP32
):
    def init_params(self):
        self.dtype = "float16"
...
class TestMultiplyInplaceInplaceDevelopCase11_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase12_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase13_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase14_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase15_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase16_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase17_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase18_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase19_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase20_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
...
class TestMultiplyInplaceInplaceDevelopCase21_FP32(
    TestMultiplyInplaceInplaceDevelopCase2_FP32
):
    def init_params(self):
        self.dtype = "float32"
