...
class TestSubtractDevelopCase1_FP32(unittest.TestCase):
    def init_dtype(self):
        self.dtype = "float32"

    def init_params(self):
        self.x_shape = [10, 1, 4, 40, 72]
        self.y_shape = [10, 1, 4, 40, 72]
        self.dout_shape = [10, 1, 4, 40, 72]
        self.init_dtype()
...
class TestSubtractDevelopCase1_FP16(TestSubtractDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float16"

class TestSubtractDevelopCase1_BF16(TestSubtractDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"
