...
class TestSwigluDevelopCase1_FP32(unittest.TestCase):
    def setUp(self):
        self.init_params()
        self.init_threshold()
    ...
    def init_np_inputs_and_dout(self):
        # init np array 
        self.np_x = np.random.random(size=[8192, 9216]).astype("float32") - 0.5
        self.np_dout = np.random.random(size=[8192, 4608]).astype("float32") - 0.5
    ...
    def cal_torch_res(self, x, dout):
        ...
        out = torch.nn.functional.silu(y1) * y2
    ...
    def cal_eager_res(self, x, dout):
        ...
        # out = paddle.nn.functional.silu(gate) * x
        out = paddle.incubate.nn.functional.swiglu(x)
...
class TestSwigluDevelopCase1_FP16(TestSwigluDevelopCase1_FP32):
    def init_params(self):
        self.dtype = "float16"


class TestSwigluDevelopCase1_BFP16(TestSwigluDevelopCase1_FP32):
    def init_params(self):
        self.dtype = "bfloat16"
