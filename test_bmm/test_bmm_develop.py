...
class TestBmmDevelopCase1_FP32(unittest.TestCase):
    def init_dtype(self):
        self.dtype = "float32"
    def init_params(self):
        self.x_shape = [320, 256, 256]
        self.y_shape = [320, 256, 128]
        self.dout_shape = [320, 256, 128]
        self.init_dtype()
...
class TestBmmDevelopCase1_FP16(TestBmmDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float16"

class TestBmmDevelopCase1_BF16(TestBmmDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"
