...
class TestExpDevelopCase1_FP32(unittest.TestCase):
    def init_dtype(self):
        self.dtype = "float32"
...
class TestExpDevelopCase1_FP16(TestExpDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float16"

class TestExpDevelopCase1_BF16(TestExpDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"

class TestExpDevelopCase2_FP32(TestExpDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float32"
    def init_params(self):
...
class TestExpDevelopCase2_FP16(TestExpDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "float16"

class TestExpDevelopCase2_BF16(TestExpDevelopCase1_FP32):
    def init_dtype(self):
        self.dtype = "bfloat16"
